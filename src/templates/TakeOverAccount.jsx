...
import {takeOverAccount} from "../reducks/users/operations";

const TakeOverAccount = () => {
  ...
  return (
    <div className="c-section-container">
      ...
      />
      <TextInput
        fullWidth={true} label={"パスワード（確認用）"} multiline={false} required={true} rows={1} value={confirmPassword} type={"password"} onChange={inputConfirmPassword}
      />
      <div className="module-spacer--medium"/>
      <div className="center">
        <PrimaryButton
        label={"アカウントを登録する"}
        onClick={() => dispatch(takeOverAccount(username, email, password, confirmPassword))}
        // クレカ登録画面に飛ばす
        />
      </div>
    </div>
...
export default TakeOverAccount
